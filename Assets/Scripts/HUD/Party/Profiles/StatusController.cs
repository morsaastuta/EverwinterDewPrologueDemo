...
public class StatusController : MonoBehaviour
{
    ...
    [SerializeField] TextMeshProUGUI showcaseFSA;
    [SerializeField] TextMeshProUGUI showcaseFRA;
    [SerializeField] TextMeshProUGUI showcaseHSA;
    [SerializeField] TextMeshProUGUI showcaseHRA;

    public void LoadStats()
    {
        Profile profile = partyController.currentProfile;
        ...
        showcaseFSA.SetText(profile.statFSA.ToString() + "%");
        showcaseFRA.SetText(profile.statFRA.ToString() + "%");
